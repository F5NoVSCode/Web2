...
<div class="container">
    ...
    <form action="{{ route('publishers.update', $publisher) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control @error('address') is-invalid @enderror" id="address" name="address" rows="2">{{ old('address', $publisher->address) }}</textarea>
            @error('address')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
        ...
        <div class="mb-3">
            ...
            <input type="url" class="form-control @error('website') is-invalid @enderror" id="website" name="website" value="{{ old('website', $publisher->website) }}">
            @error('website')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
